...
import numpy as np
import sys
sys.path.append(r'c:\Users\Administrateur\Documents\Mangeoire\BirdNET-Analyzer-1.5.1\birdnet_analyzer') 
...
if __name__ == "__main__":
    ...
    # py analyze.py --i example/ --o example/ --slist example/ --min_conf 0.5 --threads 4
